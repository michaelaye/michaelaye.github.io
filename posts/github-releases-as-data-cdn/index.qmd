...
As Mario D'Amore pointed out, HTTP range requests and COG work as well. GitHub's CDN supports [HTTP Range requests](https://developer.mozilla.org/en-US/docs/Web/HTTP/Range_requests), meaning you can read *partial* data from a file without downloading the whole thing. This is particularly powerful with formats designed for partial reads, like [Cloud Optimized GeoTIFF (COG)](https://www.cogeo.org/).
